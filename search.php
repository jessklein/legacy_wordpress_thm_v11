<?php get_header(); ?>
	...
	<div class="meta">Posted by <strong><?php the_author_posts_link(); ?></strong> | <?php the_time('j M Y') ?> | <?php the_category(', '); ?> | <?php comments_popup_link('No Comments', 'One Comment', '% Comments');?></div>	
